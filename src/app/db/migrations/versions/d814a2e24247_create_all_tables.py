...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "source_type",
            postgresql.ENUM("Jurisprudência", "Lei", name="source_type_enum"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_legalsources_source_name"),
        "legalsources",
        ["source_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_legalsources_source_type"),
        "legalsources",
        ["source_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_chatmessages_content"), "chatmessages", ["content"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "document_type",
            postgresql.ENUM("PDF", "DOCX", name="document_type_enum"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_documents_document_name"), "documents", ["document_name"], unique=True
    )
    op.create_index(
        op.f("ix_documents_file_path"), "documents", ["file_path"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "integration_type",
            postgresql.ENUM("WhatsApp", "Gmail", name="integration_type_enum"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_integrations_integration_name"),
        "integrations",
        ["integration_name"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "template_type",
            postgresql.ENUM(
                "Petição", "Apelação", "Contestação", name="template_type_enum"
            ),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
    ...
    op.create_index(
        op.f("ix_templates_template_content"),
        "templates",
        ["template_content"],
        unique=True,
    )
    op.create_index(
        op.f("ix_templates_template_name"), "templates", ["template_name"], unique=True
    )
